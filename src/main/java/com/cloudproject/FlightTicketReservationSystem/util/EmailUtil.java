package com.cloudproject.FlightTicketReservationSystem.util;
...
public class EmailUtil {
    ...
    @Value("${com.cloudproject.FlightTicketReservationSystem.itinerary.email.body}")
    private String EMAIL_BODY;

    @Value("${com.cloudproject.FlightTicketReservationSystem.itinerary.email.subject}")
